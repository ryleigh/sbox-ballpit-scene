...
public sealed class FloaterText : Component
{
	...
	public void Init( string text, float lifetime, Color color, Vector2 velocity, float deceleration, float startFontSize, float endFontSize, bool isEmoji )
	{
		Text = text;
		Lifetime = lifetime;
		TextColor = color;
		...
		FontSize = _startFontSize = startFontSize;
	...
	protected override void OnUpdate()
	{
		...
		FontSize = Utils.Map( _timeSinceSpawn, 0f, Lifetime, _startFontSize, _endFontSize, EasingType.SineOut );
